...
> Documentation index for the Listcy project.

## Contents

| Section                                         | What's inside                                                |
| ----------------------------------------------- | ------------------------------------------------------------ |
| [Architecture](./architecture/overview.md)      | Layered backend design, import rules, server/client boundary |
| [Conventions](./architecture/conventions.md)    | File naming, constants, schema barrel export                 |
